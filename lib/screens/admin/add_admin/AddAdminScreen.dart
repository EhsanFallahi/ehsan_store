...
class AddAdminScreen extends StatelessWidget {
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(children: [
              HeaderWithoutSearch(
                title: TITLE_HEADER_ADD_ADMIN_SCEEN,
              ),
  ...
  Align AdminList(BuildContext context) {
    return Align(
      ...
      child: Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, i) => Container(
            child: ListTile(
              title: Text(
                _adminController.tempListAdmins[i].userName.toUpperCase(),
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.white,
              ...
              trailing: IconButton(
                icon:
                    Icon(Icons.delete_forever_rounded, color: SECONDARY_COLOR),
                onPressed: () {
  ...
  ElevatedButton AddAdminButton() {
    return ElevatedButton(
      child: Text('Add'),
      onPressed: () {
        if (_adminController.formKey.currentState.validate()) {
